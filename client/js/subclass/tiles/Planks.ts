...
export class Planks extends Tile {
	color1 = `hsl(25, ${weightedRandom(sMin, sMax)}%, ${weightedRandom(
		lMin,
		lMax
	)}%)`;
	color2 = `hsl(25, ${weightedRandom(sMin, sMax)}%, ${weightedRandom(
		lMin,
		lMax
	)}%)`;
	color3 = `hsl(25, ${weightedRandom(sMin, sMax)}%, ${weightedRandom(
		lMin,
		lMax
	)}%)`;
	color4 = `hsl(25, ${weightedRandom(sMin, sMax)}%, ${weightedRandom(
		lMin,
		lMax
	)}%)`;
